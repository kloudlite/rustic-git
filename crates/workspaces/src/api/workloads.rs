...
const RESTARTED_AT: &str = "kloudlite.io/restarted-at";
const ROLLED_BY: &str = "kloudlite.io/rolled-by";
const ROLLED_AT: &str = "kloudlite.io/rolled-at";
const ROLL_REASON: &str = "kloudlite.io/roll-reason";
...
/// Per region: resolved against that region's client, same as `ClusterSettings`. `kloudlite-gateway`
