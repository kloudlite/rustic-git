...
use super::*;
use kloudlite_core::settings::{CentralSettings, Mark, CENTRAL_SETTING_META};
...
const CENTRAL_ENV_VARS: &[(&str, &str)] = &[
    ("maxBody", "KLOUDLITE_MAX_BODY"),
    ("maxLayer", "KLOUDLITE_MAX_LAYER"),
    ("uploadGraceSecs", "KLOUDLITE_UPLOAD_GRACE_SECS"),
    ("cloneHost", "KLOUDLITE_CLONE_HOST"),
    ("sshHost", "KLOUDLITE_SSH_HOST"),
    ("sshPort", "KLOUDLITE_SSH_PORT"),
    ("registryHost", "KLOUDLITE_REGISTRY_HOST"),
];
...
const CLUSTER_ENV_VARS: &[(&str, &str)] = &[
    ...
    ("interceptProxyImage", "WS_INTERCEPT_PROXY_IMAGE"),
...
fn cluster_default(name: &str) -> serde_json::Value {
    ...
    match name {
        ...
        "treesPerWorkspace" => defaults::trees_per_workspace().into(),
        "defaultImage" | "interceptProxyImage" => serde_json::Value::String(String::new()),
...
fn cluster_range(name: &str) -> Option<(f64, f64)> {
    match name {
        ...
        "treesPerWorkspace" => Some((1.0, 32.0)),
        "traceSampleRatio" => Some((0.0, 1.0)),
        "traceProbeRate" => Some((0.0, 1000.0)),
        "traceProbeBurst" => Some((1.0, 10_000.0)),
        "tracePromoteRate" => Some((0.0, 1000.0)),
