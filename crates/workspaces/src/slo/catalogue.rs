...
pub const CATALOGUE: &[Slo] = &[
    ...
    Slo { id: "team.member.paused", feature: "Teams", sli: "A paused member's tool token, team `/v1` and bench tunnel are refused and their bench is stopped within one beat; after unpause and start the bench folder's canary is still there", target: bound(420_000), suite: Suite::Hourly, stage: "14 · Experience" },
