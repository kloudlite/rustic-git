...
pub const CATALOGUE: &[Slo] = &[
    ...
    // Stage 2 · git
    Slo { id: "git.push.ok", feature: "Git hosting", sli: "Push of one commit over HTTP succeeds", target: avail(99.9), suite: Suite::Fast },
    Slo { id: "git.push.p95", feature: "Git hosting", sli: "Push of one commit over HTTP completes", target: p95(3_000), suite: Suite::Fast },
    Slo { id: "git.clone.ok", feature: "Git hosting", sli: "Clone over HTTP succeeds", target: avail(99.9), suite: Suite::Fast },
    Slo { id: "git.clone.p95", feature: "Git hosting", sli: "Clone over HTTP completes", target: p95(2_000), suite: Suite::Fast },
    Slo { id: "ssh.clone.ok", feature: "Git hosting", sli: "Clone over SSH succeeds", target: avail(99.9), suite: Suite::Fast },
    Slo { id: "ssh.hostkey", feature: "Git hosting", sli: "The SSH host key served matches the pinned fingerprint", target: avail(100.0), suite: Suite::Fast },
    Slo { id: "ssh.unregistered.refused", feature: "Git hosting", sli: "SSH from an unregistered key is refused", target: avail(99.9), suite: Suite::Fast },
    Slo { id: "browse.p95", feature: "Git hosting", sli: "The Browse API renders a repo page", target: p95(500), suite: Suite::Fast },
    Slo { id: "browse.commit.visible", feature: "Git hosting", sli: "A pushed commit becomes visible in Browse", target: bound(5_000), suite: Suite::Fast },
    Slo { id: "web.repo.page", feature: "Git hosting", sli: "The web app's repo page loads", target: p95(1_500), suite: Suite::Fast },
    ...
    Slo { id: "reg.push.ok", feature: "Container registry", sli: "Pushing an image succeeds", target: avail(99.9), suite: Suite::Fast },
    Slo { id: "reg.manifest.p95", feature: "Container registry", sli: "Fetching a manifest completes", target: p95(500), suite: Suite::Fast },
    Slo { id: "reg.tags.visible", feature: "Container registry", sli: "A pushed tag becomes visible in the tag list", target: bound(5_000), suite: Suite::Fast },
    Slo { id: "reg.shared.layer", feature: "Container registry", sli: "A shared layer is not re-uploaded by a sibling image", target: avail(100.0), suite: Suite::Fast },
    Slo { id: "reg.canary", feature: "Container registry", sli: "The registry canary image pulls successfully", target: avail(100.0), suite: Suite::Fast },
    Slo { id: "reg.visibility", feature: "Container registry", sli: "Image visibility (public vs. private) is enforced", target: avail(100.0), suite: Suite::Fast },

    // Stage 5 · workspace
    Slo { id: "ws.create.p95", feature: "Workspaces", sli: "Creating a workspace completes", target: p95(90_000), suite: Suite::Fast },
    Slo { id: "ws.exec.ok", feature: "Workspaces", sli: "Exec into a running workspace pod succeeds", target: avail(99.9), suite: Suite::Fast },
    Slo { id: "homes.rw.p95", feature: "Workspaces", sli: "A read/write round trip on the shared home completes", target: p95(200), suite: Suite::Fast },
    Slo { id: "gw.tunnel.p95", feature: "Workspaces", sli: "Opening a gateway SSH tunnel completes", target: p95(3_000), suite: Suite::Fast },
    Slo { id: "gw.unregistered.refused", feature: "Workspaces", sli: "The gateway refuses an unregistered key", target: avail(99.9), suite: Suite::Fast },
    Slo { id: "ws.push.p95", feature: "Workspaces", sli: "Pushing a workspace snapshot completes", target: p95(60_000), suite: Suite::Fast },
    Slo { id: "ws.clone.p95", feature: "Workspaces", sli: "Cloning a workspace completes", target: p95(60_000), suite: Suite::Fast },
    Slo { id: "quota.refused", feature: "Workspaces", sli: "An over-quota create is refused with 409", target: avail(100.0), suite: Suite::Fast },
    ...
    // Stage 7 · lifecycle
    Slo { id: "ws.stop.p95", feature: "Workspace lifecycle", sli: "Stopping a workspace completes", target: p95(15_000), suite: Suite::Fast },
    Slo { id: "ws.replicated", feature: "Workspace lifecycle", sli: "A stopped workspace's final sync point reaches a replica", target: bound(300_000), suite: Suite::Fast },
    Slo { id: "ws.start.p95", feature: "Workspace lifecycle", sli: "Starting a workspace completes", target: p95(30_000), suite: Suite::Fast },
    Slo { id: "ws.restore", feature: "Workspace lifecycle", sli: "Restoring a workspace from a past snapshot succeeds", target: avail(99.9), suite: Suite::Fast },
    Slo { id: "vol.refusals", feature: "Workspace lifecycle", sli: "Deleting a sync point or a running worktree's base snapshot is refused", target: avail(100.0), suite: Suite::Fast },
    Slo { id: "vol.detached.restorable", feature: "Workspace lifecycle", sli: "A detached volume's snapshot can still be restored", target: avail(99.9), suite: Suite::Fast },
    ...
    // Stage 9 · security
    Slo { id: "sec.private.repo", feature: "Security", sli: "A private repo is unreadable to a non-collaborator", target: avail(100.0), suite: Suite::Fast },
    Slo { id: "sec.cross.owner", feature: "Security", sli: "One owner's objects are invisible to another owner", target: avail(100.0), suite: Suite::Fast },
    Slo { id: "sec.admin.claim", feature: "Security", sli: "An admin route refuses a token without the superadmin claim", target: avail(100.0), suite: Suite::Fast },
    Slo { id: "sec.user.process", feature: "Security", sli: "The ordinary API process has no admin route mounted", target: avail(100.0), suite: Suite::Fast },
    Slo { id: "sec.agent.spec", feature: "Security", sli: "The admission policy refuses a spec write outside the allowed fields", target: avail(100.0), suite: Suite::Fast },
    Slo { id: "id.token.revoked", feature: "Security", sli: "A revoked token is refused", target: avail(99.9), suite: Suite::Fast },

    // Stage 10 · edge and pipeline
    Slo { id: "edge.dns", feature: "Edge and pipeline", sli: "The public hostname resolves", target: avail(99.99), suite: Suite::Fast },
    ...
    // Weekly
    Slo { id: "git.push.large", feature: "Git hosting", sli: "Push of a large commit over HTTP succeeds", target: avail(99.9), suite: Suite::Weekly },
    Slo { id: "reg.push.large", feature: "Container registry", sli: "Pushing a large image layer succeeds", target: avail(99.9), suite: Suite::Weekly },
    Slo { id: "ws.cold.profile", feature: "Workspaces", sli: "A cold package profile builds successfully", target: avail(99.9), suite: Suite::Weekly },
    ...
    Slo { id: "bak.daily.slots", feature: "Backups", sli: "Every daily backup slot is present", target: avail(99.9), suite: Suite::Monthly },
    Slo { id: "bak.versioning", feature: "Backups", sli: "Backup versioning is enabled and retains history", target: avail(99.9), suite: Suite::Monthly },
    Slo { id: "bak.cosmos", feature: "Backups", sli: "The Cosmos backup for HyperDX succeeds", target: avail(99.9), suite: Suite::Monthly },
    Slo { id: "drill.dead.node", feature: "Resilience drills", sli: "A dead-node drill heals every replica onto a live node", target: avail(99.9), suite: Suite::Monthly },
    Slo { id: "drill.drain", feature: "Resilience drills", sli: "A drain drill succeeds without interrupting a running worktree", target: avail(99.9), suite: Suite::Monthly },
    Slo { id: "drill.redis.down", feature: "Resilience drills", sli: "The system keeps operating correctly with Redis down", target: avail(99.9), suite: Suite::Monthly },
];
