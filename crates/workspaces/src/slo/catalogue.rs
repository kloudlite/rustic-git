...
pub const CATALOGUE: &[Slo] = &[
    ...
    Slo { id: "team.member.removed.cleanup", feature: "Teams", sli: "A removed member's bench, team workspace, sync points and space choice are deleted within two beats of delete-now, the pushed snapshot and its volume are kept, the removal is audited, and a re-added person finds no bench", target: avail(99.9), suite: Suite::Monthly, stage: "13 · Monthly" },
