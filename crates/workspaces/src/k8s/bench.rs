...
//!
//! Everything below `bench_container` is the pre-unification `Bench` pod builder, still live
//! because `bins/agent` reconciles legacy `Bench` objects until the backfill retires them.
//! removed in Task 4.
