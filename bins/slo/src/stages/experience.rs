...
pub async fn run(c: &mut Ctx) {
    for id in IDS {
        ...
        match *id {
            ...
            "team.namespace.reaped" => super::experience_teams::namespace_reaped(c).await,
            ...
            "env.space.cleared" => super::experience_gaps::space_cleared(c).await,
