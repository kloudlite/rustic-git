...
const SNAPSHOTS_LIST: &str = "/apis/kloudlite.io/v1alpha1/snapshots";
...
const WS_CLONE_OBJ: &str = "/apis/kloudlite.io/v1alpha1/workspaces/ws-clone";
const WS_1_OBJ: &str = "/apis/kloudlite.io/v1alpha1/workspaces/ws-1";
...
const VOL_WS1: &str = "/apis/kloudlite.io/v1alpha1/volumes/ws-1";
...
const STOP_REQ: &str = "/apis/kloudlite.io/v1alpha1/snapshots/stop-env-1-1";
const ENV_PATCH: &str = "/apis/kloudlite.io/v1alpha1/environments/env-1";
const DEP_DEL: &str = "/apis/apps/v1/namespaces/env-1/statefulsets/db";
const REPLICAS: &str = "/apis/kloudlite.io/v1alpha1/volumereplicas";
...
const WS_STOP_REQ: &str = "/apis/kloudlite.io/v1alpha1/snapshots/stop-ws-1-1";
...
const ENV_STATUS_PATH: &str = "/apis/kloudlite.io/v1alpha1/environments/env-1/status";
...
const VOL_PATCH: &str = "/apis/kloudlite.io/v1alpha1/volumes/env-1";
...
const ENV_STATUS: &str = "/apis/kloudlite.io/v1alpha1/environments/env-1/status";
const SRC_VOL: &str = "/apis/kloudlite.io/v1alpha1/volumes/env-src";
...
fn parent_at(name: &str, volume: &str, phase: crd::Phase, pod: Option<&str>) -> kloudlite_agent::listing::Parent {
...
fn stopped_parent(name: &str, volume: &str) -> kloudlite_agent::listing::Parent {
    parent_at(name, volume, crd::Phase::Stopped, None)
}

fn running_parent(name: &str, volume: &str) -> kloudlite_agent::listing::Parent {
...
const VOL_WS_SRC: &str = "/apis/kloudlite.io/v1alpha1/volumes/ws-src";
...
const WS_OBJ: &str = "/apis/kloudlite.io/v1alpha1/workspaces/ws-1";
const WEB_STS: &str = "/apis/apps/v1/namespaces/env-1/statefulsets/web";
const WEB_SVC: &str = "/api/v1/namespaces/env-1/services/web";
const WEB_SLICE: &str = "/apis/discovery.k8s.io/v1/namespaces/env-1/endpointslices/web-intercept";
const ENV_POLICY: &str = "/apis/networking.k8s.io/v1/namespaces/env-1/networkpolicies/intercept-ws-1";
const WS_POLICY: &str = "/apis/networking.k8s.io/v1/namespaces/ws-alice/networkpolicies/intercept-ws-1";
...
fn intercept_env(intercepts: serde_json::Value, prev_by: Option<&str>) -> crd::Environment {
    let mut e = environment(serde_json::json!({
...
fn one_intercept() -> serde_json::Value {
...
fn intercept_routes(extra: Vec<Route>) -> Vec<Route> {
...
fn ready_pod(ready_since: i64) -> serde_json::Value {
    serde_json::json!({
        "apiVersion": "v1", "kind": "Pod",
