...
//   cd web && RUSTIC_GIT_ADMIN_FIXTURES=1 AUTH_SECRET=dev-secret AUTH_URL=http://localhost:3000 \
//     bun run dev
//   AUTH_SECRET=dev-secret node scripts/superadmin-screens.mjs [http://localhost:3000]
//
// `RUSTIC_GIT_ADMIN_FIXTURES=1` is what makes the pages render without an admin API: every GET the
