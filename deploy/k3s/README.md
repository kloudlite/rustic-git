...
| `system-netpol.yaml` | Default-deny plus the one 2049-from-agents rule in `rustic-git-system`: the NFS home export authenticates nothing, so reachability is the authorization. Apply with `zerofs.yaml`. |
