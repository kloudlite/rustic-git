...
| **MisdirectedWrites** | `sum(rate(http_requests_total{status="421"}[5m])) > 0.1` for 10m | 421s during a roll are expected; sustained ones mean the pods disagree about who holds the leader lease. |
