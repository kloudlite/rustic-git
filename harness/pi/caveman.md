<!-- vendored from https://github.com/JuliusBrussee/caveman skills/caveman/SKILL.md; the harness identity prompt embeds this file (full level). Chat text only — code, files, commits stay normal prose. -->
---
name: caveman
description: >
