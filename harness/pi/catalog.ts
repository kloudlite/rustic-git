...
export const TOOLS: ToolSpec[] = [
  ...
  { name: "kl_workspace", group: "workspace", summary: "One workspace in full: state, node, packages, attached environment.", effect: "read" },
  ...
  { name: "kl_workspace_attach", group: "workspace", summary: "Attach a workspace to an environment (its services resolve by name).", effect: "write" },
  { name: "kl_workspace_detach", group: "workspace", summary: "Detach a workspace from its environment.", effect: "write" },
