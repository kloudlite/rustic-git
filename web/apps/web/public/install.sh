...
# Everything inside a function, called on the LAST line: `sh` runs what it has read so far,
# so a download cut mid-file used to execute half a script. Now a partial file defines
