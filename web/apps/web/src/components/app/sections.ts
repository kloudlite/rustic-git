import { Container, House, Layers, Settings, SquareCode, SquareTerminal, type LucideIcon } from "lucide-react";
...
/** Home — the namespace itself — then the four parts of the product in the order work moves through
 *  them: the code, the place it is worked on, the place it runs, and the
 *  images it ships. Section routes hang off the owner, so this is a
 *  function of it. */
