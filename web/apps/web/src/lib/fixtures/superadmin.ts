...
export const CATALOGUE: [string, string, string, string, string, string][] = [
  ...
  ["bench.tool.audience", "Benches", "The pod's token is refused on `/v1/bench/session` and `/v1/keys`", "99.9 %", "hourly", "14 · Experience"],
  ["bench.tool.revoked", "Benches", "After a stop the next pod call is 401 at once; after the parent login is revoked a pod call is 401 within 60 s", "99.9 % ≤ 90000 ms", "hourly", "14 · Experience"],
