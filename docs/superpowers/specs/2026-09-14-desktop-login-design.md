...
Team/region picker, importing laptop sessions, OAuth/passkey inside the app window, token refresh (server has none), Windows/Linux keychain differences beyond `safeStorage`.
